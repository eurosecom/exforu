...
public class GetLearningStreamAsyncTask extends AsyncTask<Void, Void, Void> {
 ...
 GetLearningStreamAsyncTask(Activity activity, DoSomething callback, int max, String account, String userpsw, long userid
