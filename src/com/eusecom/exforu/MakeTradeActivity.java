...
public class MakeTradeActivity extends Activity {
    ...
    class SaveTradeModel extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
        	...
        	String titlex="";
        	if( xtrade.equals("1")) { titlex=getString(R.string.tradeordered); }
        	if( xtrade.equals("2")) { titlex=getString(R.string.tradeordered); }
        	if( xtrade.equals("3")) { titlex=getString(R.string.tradeclosed); }
        	if( xtrade.equals("4")) { titlex=getString(R.string.tradeclosed); }
    ...
    class SaveTrade extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
        	...
        	if( xtrade.equals("1")) { titlex=getString(R.string.tradeordered); }
        	if( xtrade.equals("2")) { titlex=getString(R.string.tradeordered); }
        	if( xtrade.equals("3")) { titlex=getString(R.string.tradedeleted); }
        	if( xtrade.equals("4")) { titlex=getString(R.string.tradedeleted); }
